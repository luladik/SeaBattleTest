...
public class MapUpdateHandler {
    ...
    private Map<Integer, String> helpMap = new HashMap<Integer, String>();
    ...
    public MapUpdateHandler(String appPath) {
        ...
        Collections.addAll(this.reservedList, MyDefines.RESERVED_LIST);

        //copy the board right corner list from MyDefines class (only to use method contains)
        Collections.addAll(this.rightBorderList, MyDefines.BORDER_RIGHT_LIST);
    ...
    public boolean updateMap(int orientation, ArrayList<Integer> indexes) {
        ...
        for (Integer indexe : indexes) {
            ...
            if (this.reservedList.contains(indexe)) {
                return false;
            }
        }
    ...
    public boolean randomAllocation() {
        ArrayList<Integer> myListIndex = new ArrayList<Integer>();
        ArrayList<Integer> myListOrientation = new ArrayList<Integer>();
    ...
    public boolean isGameOver() {
        ...
        for (Integer aMatrixMap : this.MatrixMap) {
            if (aMatrixMap == 2 || aMatrixMap == 3 || aMatrixMap == 4 || aMatrixMap == 5 ||
                    aMatrixMap == 10 || aMatrixMap == 11 || aMatrixMap == 12 || aMatrixMap == 13 || aMatrixMap == 14 || aMatrixMap == 15 ||
                    aMatrixMap == 22 || aMatrixMap == 23 || aMatrixMap == 24 || aMatrixMap == 25 || aMatrixMap == 26 || aMatrixMap == 27 ||
                    aMatrixMap == 34 || aMatrixMap == 35 || aMatrixMap == 36 || aMatrixMap == 37 || aMatrixMap == 38 || aMatrixMap == 39 || aMatrixMap == 40 || aMatrixMap == 41 ||
                    aMatrixMap == 50 || aMatrixMap == 51 || aMatrixMap == 52 || aMatrixMap == 53 || aMatrixMap == 54 || aMatrixMap == 55 || aMatrixMap == 56 || aMatrixMap == 57 || aMatrixMap == 58 || aMatrixMap == 59
                    ) {
                return false;
            }
        }
