...
import com.kapitsa.network.MyClient;
import com.kapitsa.network.MyServer;
...
public class BattleShip extends JFrame implements ActionListener {
                                                      ...
                                                      if (myServerObj.getHasClient() && myMapUpdate.getMyTurn()) {
                                                          ...
                                                          if (myEnemyMapUpdate.isPositionLegal(index)) {
                                                              ...
                                                              if (myMapUpdate.positionPlayed(index)) {
                                                                  JOptionPane.showMessageDialog(myFrame, "You have already hit this position, " +
                                                                          "try another one.");
                                                              } else {
                                                                  ...
                                                                  //inform
                                                                  writeOutputMessage(" - Your bomb goes to: " +
                                                                          myEnemyMapUpdate.getLine(index) + myEnemyMapUpdate.getColumn(index));
                                                              }
                                                          }
                                                          //not a legal position
                                                          else {
                                                              JOptionPane.showMessageDialog(myFrame, "You tried to play in a not legal position." +
                                                  ...
                                                  //playing as client
                                                      ...
                                                      if (myClientObj.getIsConnected() && myMapUpdate.getMyTurn()) {
                                                          ...
                                                          //not a legal position
                                                              ...
                                                              JOptionPane.showMessageDialog(myFrame, "You tried to play in a not legal position." +
                                                                      " Please, choosen another position on the board.");
                                                          }
                                                      }
                                                  }
                                              }
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                while (!myMapUpdate.randomAllocation()) {
                    ...
                    if (timeOutCounter >= MyDefines.DELAY_5S) {
                        JOptionPane.showMessageDialog(myFrame,
                                "Timeout error. Please press \"New Allocation\" again.");
                        myMapUpdate.restartAllocation();
                        myRenderer.updateMatrix(myMapUpdate.getMatrixMap());
                        myBoardList.repaint();
                        return;
    ...
    private void initializeConnectionPanel() {
        ...
        connectionPanel.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0), 1, true),
                "Connection Configuration:", TitledBorder.LEFT, TitledBorder.TOP, null, null));
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                if (IsServer) {
                    ...
                    if (ipAddressTextField.getText().equals("") || portTextField.getText().equals("")) {
                        JOptionPane.showMessageDialog(myFrame,
                                "You have to write the server's IP address and the port before start the game.");
                    } else {
                ...
                //player as a client
                    ...
                    if (myMapUpdate.isSelectionDone()) {
                        ...
                        if (ipAddressTextField.getText().equals("") || portTextField.getText().equals("")) {
                            ...
                            if (myClientObj.StartConnection(ipAddressTextField.getText(),
    ...
    private void initializeComponents() {
        ...
        setTitle("Sea Battle Softsky | Kapitsa");
...
//        }
    ...
    public void enableShipAllocation(boolean value) {
        if (value && this.rdbtnManualAllocation.isSelected()) {
            this.btnNewAllocation.setEnabled(false);
        } else {
