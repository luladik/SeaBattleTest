...
import com.kapitsa.gui.BattleShip;
import com.kapitsa.gui.MyDefines;
            ...
            try {
                ...
                if (!msg.equals("")) {
                    switch (msg.charAt(0)) {
                        ...
                        {
                            int index = Integer.parseInt(msg.substring(2));
                        ...
                        {
                            String[] impMsg = msg.substring(2).split(";");
                        ...
                        case 'D': //dice: talking to server
                        {
                            if (msg.charAt(1) == 'Q') {
                                ...
                                String[] impMsg = msg.substring(3).split(";");
                        ...
                        case 'S': //message from server first connection
                        {
                            if (msg.charAt(1) == 'N') {
                                ...
                                this.gui.writeOutputMessage(" - Enemy says: " + msg.substring(2));
                        ...
                        {
                            this.gui.writeChatMessage(msg.substring(2), 1);
                            break;
                        }
